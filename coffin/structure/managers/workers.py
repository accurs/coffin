...
class Workers:
  def __init__(self, workers: list, captcha_key: str):
    ...
    self.useragent = "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9177 Chrome/128.0.6613.186 Electron/32.2.7 Safari/537.36"
  ...
  def get_cookies(self) -> str:
    ...
    if req.status_code == 200:
      ...
      return "__dcfduid=51523060c63211efa6a633f394ff05e0; __sdcfduid=51523061c63211efa6a633f394ff05e007dd01b9eec336efa0410b2f72a930e36306b8495a1de90295e7c60009452b23; __cfruid=ee9619911e2b0a1ce23c574d44caf1ea6800163d-1736865884; _cfuvid=JVoU6SSNiKOSlFIMnZJH8_vp93.IPqm_Y3arh95YOvE-1736865884906-0.0.1.1-604800000; locale=en-US"
