...
class VoiceMasterView(discord.ui.View):
  ...
  async def interaction_check(self, interaction: discord.Interaction):
    ...
    if str(channel.id) not in voice_channels.keys():
      await interaction.response.send_message(
  ...
  @discord.ui.button(emoji="<:lock:1315725552614637599>", custom_id="vm:lock")
  ...
  @discord.ui.button(emoji="<:unlock:1315725554393153556>", custom_id="vm:unlock")
  ...
  @discord.ui.button(emoji="<:ghost:1315725555907432470>", custom_id="vm:hide")
  ...
  @discord.ui.button(emoji="<:unghost:1315725558293856268>", custom_id="vm:reveal")
  ...
  @discord.ui.button(emoji="<:info:1315725560000811038>", custom_id="vm:rename")
...
class TicketClose(discord.ui.View):
  ...
  async def interaction_check(self, interaction: discord.Interaction):
    ...
    if (
      interaction.user.id not in support
